...
- **External research**: adopt the research method (`kraken-abyssal`) for libraries/frameworks.
- **Architecture**: adopt the architecture method (`kraken-architect`) for design questions.
